...
export AWS_ACCESS_KEY_ID=$(bws -c no secret get eb5eb0e8-2a4a-4398-a756-b37000d87d64 | jq -r '.value')
export AWS_SECRET_ACCESS_KEY=$(bws -c no secret get c39086cc-e112-40eb-b19f-b37000d89090 | jq -r '.value')
